#+TITLE: Library as a Gem -  libjpeg-turbo
#+LATEX: \pagebreak

* Overview

  ~laag-libjpeg-turbo~ packages [[https://github.com/libjpeg-turbo/libjpeg-turbo][libjpeg-turbo] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
